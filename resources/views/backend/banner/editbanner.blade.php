...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            ...
            <p class="pageheader-text">Halaman untuk edit banner</p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/banner/edit/{{$banner->id}}" class="breadcrumb-link">Tambah Banner</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <h3 class="text-center">Edit Banner</h3>
            ...
            {{ csrf_field() }} {{ method_field('POST') }}
                <div class="form-group">
                    ...
                    <input id="thumbnail" class="form-control" type="text" name="photo" value="{{$banner->photo}}" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-control">
                        <option value="pengumuman" {{(($banner->status=='pengumuman')? 'selected' : '')}}>Pengumuman</option>
                        <option value="mahasiswa" {{(($banner->status=='mahasiswa')? 'selected' : '')}}>mahasiswa</option>
                    </select>
                </div>
                <div class="form-group">
