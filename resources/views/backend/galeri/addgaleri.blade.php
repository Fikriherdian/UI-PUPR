...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Tambah Galeri</h2>
            <p class="pageheader-text">Halaman untuk menambah galeri</p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/galeri/tambah" class="breadcrumb-link">Tambah Galeri</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <h3 class="text-center">Menambah Galeri</h3>
            <form method="POST"action="/admin/galeri/store" enctype="multipart/form-data">
            {{ csrf_field() }} {{ method_field('POST') }}
                ...
                <div class="form-group inp">
                    ...
                    <div class="input">
                        <input type="text" name="caption" id="caption" autocomplete="off" class="inp" required> 
                    </div> 
                </div>
                <div class="form-group">
