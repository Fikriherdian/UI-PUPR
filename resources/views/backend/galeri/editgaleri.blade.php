...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Edit Galeri</h2>
            <p class="pageheader-text">Halaman untuk edit galeri</p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/galeri/edit/{{$galeri->id}}" class="breadcrumb-link">Tambah Galeri</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <h3 class="text-center">Edit Galeri</h3>
            <form method="POST"action="/admin/galeri/update/{{$galeri->id}}" enctype="multipart/form-data">
            {{ csrf_field() }} {{ method_field('POST') }}
                <div class="form-group">
                    ...
                    <input id="thumbnail" class="form-control" type="text" name="photo" value="{{$galeri->photo}}" required>
                    </div>
                ...
                <div class="form-group inp">
                    ...
                    <div class="input">
                        <input type="text" name="caption" id="caption" autocomplete="off" class="inp" value="{{$galeri->caption}}" required> 
                    </div> 
                </div>
                <div class="form-group">
