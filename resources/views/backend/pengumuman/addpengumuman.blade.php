...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Tambah Pengumuman</h2>
            <p class="pageheader-text">Halaman untuk menambah pengumuman</p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('pengumuman.create')}}" class="breadcrumb-link">Tambah Pengumuman</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <h3 class="text-center">Menambah Pengumuman</h3>
            ...
            {{ csrf_field() }} {{ method_field('POST') }}
                ...
                <div class="form-group">
                    <label for="page">Deskripsi<span class="text-danger">*</span></label>
