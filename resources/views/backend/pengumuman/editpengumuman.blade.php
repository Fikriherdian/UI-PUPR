...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Edit Pengumuman</h2>
            <p class="pageheader-text">Halaman untuk edit pengumuman</p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin" class="breadcrumb-link">Admin</a></li>
                        <li class="breadcrumb-item"><a href="{{route('pengumuman.index')}}" class="breadcrumb-link">Pengumuman</a></li>
                        <li class="breadcrumb-item"><a href="{{route('pengumuman.edit',$pengumuman->id)}}" class="breadcrumb-link">Edit Pengumuman</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <h3 class="text-center">Edit Pengumuman</h3>
            ...
            @method('PATCH')
                <div class="form-group inp">
                    ...
                    <div class="input">
                        <input type="text" name="judul" id="judul" autocomplete="off" class="inp" value="{{$pengumuman->judul}}" required> 
                    </div> 
                </div>
                <div class="form-group">
                    <label for="deskripsi">Deskripsi<span class="text-danger">*</span></label>
                    <textarea id="summernote" name="deskripsi" >{{$pengumuman->page}}</textarea>
                </div>
                <div class="form-group">
