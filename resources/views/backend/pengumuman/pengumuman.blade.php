...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Semua pengumuman</h2>
            <p class="pageheader-text">Halaman untuk melihat semua pengumuman</p>
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <h3 class="text-center">Semua Pengumuman</h3>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group ml-auto">
                            <a href="{{route('pengumuman.edit',$b->id)}}" class="btn btn-sm btn-outline-light"><i class="fas fa-eye"></i></a>
                            <form method="POST" action="{{route('pengumuman.destroy',$b->id)}}">
                            @csrf
                            @method('delete')
