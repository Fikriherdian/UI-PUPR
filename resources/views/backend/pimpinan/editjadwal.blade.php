...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            ...
            <p class="pageheader-text">Halaman untuk edit jadwal</p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('jadwal.edit',$jadwal->id)}}" class="breadcrumb-link">Edit Jadwal</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <h3 class="text-center">Edit Jadwal</h3>
            ...
            @method('PATCH')
                <div class="form-group inp">
                    ...
                    <div class="input">
                        <input type="text" name="judul" id="judul" autocomplete="off" class="inp" value="{{$jadwal->judul}}" required> 
                    </div> 
                </div>
                <div class="form-group inp">
                    <label for="judul">Tanggal<span class="text-danger">*</span></label>
                    <div class="input">
                        <input id="date" type="text" name="date" id="judul" autocomplete="off" class="inp" value="{{$jadwal->date}}" required>
                    </div> 
                </div>
