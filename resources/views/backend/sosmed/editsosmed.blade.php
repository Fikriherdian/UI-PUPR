...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Edit Sosmed</h2>
            <p class="pageheader-text">Halaman untuk edit sosmed</p>
        ...
        <h3 class="text-center">Menambah Sosmed</h3>
            ...
            @method('PATCH')
                <div class="form-group inp">
                    ...
                    <div class="input">
                        <input type="text" name="nama" id="nama" autocomplete="off" class="inp" value="{{$sosmed->nama}}" required> 
                    </div> 
                </div>
                <div class="form-group inp">
                    <label for="link">Link<span class="text-danger">*</span></label>
                    <div class="input">
                        <input type="text" name="link" id="link" autocomplete="off" class="inp" value="{{$sosmed->link}}" required> 
                    </div> 
                </div>
                <div class="form-group">
                    <label for="inputPhoto" class="col-form-label">Icon <span class="text-danger">*</span></label>
                    ...
                    <input id="thumbnail" class="form-control" type="text" name="icon" value="{{$sosmed->icon}}" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value="aktif" {{(($sosmed->status=='aktif')? 'selected' : '')}}>Aktif</option>
                        <option value="nonaktif" {{(($sosmed->status=='nonaktif')? 'selected' : '')}}>Nonaktif</option>
                    </select>
                </div>
