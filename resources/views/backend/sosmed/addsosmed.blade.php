...
<div class="row"> 
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Tambah Sosmed</h2>
            <p class="pageheader-text">Halaman untuk menambah sosmed</p>
        ...
        <h3 class="text-center">Menambah Sosmed</h3>
            ...
            {{ csrf_field() }} {{ method_field('POST') }}
                ...
                <div class="form-group inp">
                    ...
                    <div class="input">
                        <input type="text" name="link" id="link" autocomplete="off" class="inp" required> 
                    </div> 
                </div>
                <div class="form-group">
                    ...
                    <input id="thumbnail" class="form-control" type="text" name="icon" value="{{old('icon')}}" required>
                    </div>
