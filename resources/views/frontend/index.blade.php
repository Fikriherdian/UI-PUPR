  ...
  <div class="content">
    <div style="background-image: url('images/nav.png'); background-size: 100% auto;">
      <!-- NABAR START -->
          ...
          <!-- <div class="container"> -->
          <nav class="navbar navbar-expand-lg navbar-light bg-transparant menu" >
              ...
              <ul class="navbar-nav mr-auto mt-1 mt-lg-0 ml-5">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="#">Spesialis</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="#">Bidan Permukiman</a>
                    <a class="dropdown-item" href="#">Bidang Jalan</a>
        ...
        <div>
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active">
                    <img src="images/carousel/block_601762f410fc9.png" alt="Los Angeles" style="width:100%;">
