...
<html>
  ...
  <div class="content">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
              <ul class="navbar-nav mr-auto mt-1 mt-lg-0 ml-5" >
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="#">Pasca Pendidikan</a>
                    <a class="dropdown-item" href="#">Pasca Diklat</a>
                  </div>
                </li>
                <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-3">
              ...
              <ul>
                ...
                <li>Pendidikan Superspesialis</li>
                <li>On Going</li>
                <li>Alumni</li>
              </ul>
          </div>
          <div class="col-6">
              <h1>PELATIHAN</h1>
              <ul>
                <li>Kalender Pelatihan</li>
                <li>Informasi Pelatihan</li>
                <li>Bidang SDA</li>
                <li>Bidang Permukiman</li>
              </ul>
              <h1>PRODUK</h1>
              <ul>
                <li>Rencana Strategis</li>
                <li>Kurikulum Modul</li>
                <li>Produk Hukum</li>
                <li>FAQ</li>
        ...
        <div class="row" style="margin-top:100px">
          <div class="col-3">
            ...
            <ul>
              ...
              <li>Pengumuman</li>
              <li>Berita SDA</li>
              <li>Berita Permukiman</li>
            </ul>
            <h1>EVALUASI</h1>
            <ul>
              <li>Pasca Pendidikan</li>
              <li>Pasca Diklat</li>
            </ul>
            <h1>PPID</h1>
            <h1>KONTAK</h1>
    ...
    -------------------------------->
      <div class="copyright">
        <p>Hak Cipta @2021 PUSAT PENGEMBANGAN KOMPETENSI SUMBER DAYA AIR DAN PERMUKIMAN All Right Reserved</p>
      </div>
